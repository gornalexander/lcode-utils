...
renormalize_units = lambda n: "nm, um, mm, cm, m = np.array([1e-7, 1e-4, 1e-1, 1, 100]) / (c/sqrt(4*pi*{}*e**2/m_e)); fs, ps, ns, us, ms, s = np.array([1e-15, 1e-12, 1e-9, 1e-6, 1e-3, 1]) * sqrt(4*pi*{}*e**2/m_e)".format(n, n)
